...
rem Launch:  Start-Process cmd.exe -ArgumentList '/c','pxpipe-run.cmd' -WorkingDirectory 'O:\user files\Projects\forks\pxpipe'
...
cd /d "O:\user files\Projects\forks\pxpipe"
